...
def processs():
    temperatures = float(e2.get())
    mytemps = (temperatures * 9 / 5) + 32
    e1.insert(0, str(mytemps))
...
e1 = Entry(window, bg="black", fg="white")
e2 = Entry(window, bg="black", fg="white")
e1.grid(row=0, column=1)
e2.grid(row=1, column=1)

b1 = Button(window, text="화씨->섭씨", command=process)
b2 = Button(window, text="섭씨->화씨", command=processs)
